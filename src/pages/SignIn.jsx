...
export function SignIn() {
  ...
  return (
    <div className="min-h-screen w-screen flex justify-center items-center bg-zinc-900 bg-[url('./assets/bg-login.jpg')] bg-cover relative before:absolute before:w-full before:h-full before:bg-black/90 max-sm:min-h-screen">
      <div className="w-[800px] h-[60vh] backdrop-blur-sm bg-black/15 p-10 rounded-3xl shadow-black/20 shadow-xl  flex justify-center items-center flex gap-6 max-lg:w-full max-lg:mx-10 max-sm:flex-col max-sm:min-h-screen max-sm:py-10 max-sm:px-0 max-sm:w-screen max-sm:m-2" >
